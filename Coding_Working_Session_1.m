...
yp2 =Yp2(sc0stator,alpha2*180/pi)
xi =(90-abs(alpha2*180/pi))/(90-abs(alpha3p)*180/pi)

KRe = (1+(gamma-1)/2 * M2^2)^(gamma/(gamma-1))/((1+(gamma-1)/2 *M2^2)^((gamma)/(gamma-1))*(yp1))
